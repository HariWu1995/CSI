...
<!-- <img src='assets/InstantStyle/pipe.png'> -->

<div align="center">
<img src='assets/InstantStyle/page0.png' width=900 >
</div>
...
<p align="center">
  <img src="assets/InstantStyle/subtraction.png">
</p>
...
<p align="center">
  <img src="assets/InstantStyle/tree.png">
</p>
...
<p align="center">
  <img src="assets/InstantStyle/example1.png">
  <img src="assets/InstantStyle/example2.png">
</p>

### Image-based Stylized Synthesis

<p align="center">
  <img src="assets/InstantStyle/example3.png">
</p>

### Comparison with Previous Works

<p align="center">
  <img src="assets/InstantStyle/comparison.png">
</p>
...
# load SDXL pipeline
pipe = SDXLPipeline.from_pretrained(base_model_path, torch_dtype=torch.float16,
...
from diffusers import StableDiffusionXLPipeline as SDXLPipeline
from transformers import CLIPVisionModelWithProjection as CLIPVision

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

image_encoder = CLIPVision.from_pretrained(
...
female_mask = Image.open("./assets/InstantStyle/female_mask.png")
male_mask = Image.open("./assets/InstantStyle/male_mask.png")
background_mask = Image.open("./assets/InstantStyle/background_mask.png")
composition_mask = Image.open("./assets/InstantStyle/composition_mask.png")

mask_processor = IPAdapterMaskProcessor()
mask_size = dict(height=1024, width=1024)
mask1 = mask_processor.preprocess([composition_mask], **mask_size)
mask2 = mask_processor.preprocess([female_mask, male_mask, background_mask], **mask_size)
mask2 = mask2.reshape(1, mask2.shape[0], mask2.shape[2], mask2.shape[3])   # output -> (1, 3, 1024, 1024)

ip_female_style = Image.open("./assets/InstantStyle/ip_female_style.png")
ip_male_style = Image.open("./assets/InstantStyle/ip_male_style.png")
ip_background = Image.open("./assets/InstantStyle/ip_background.png")
ip_composition_image = Image.open("./assets/InstantStyle/ip_composition_image.png")
...
<p align="center">
  <img src="assets/InstantStyle/multi_instantstyle.png">
</p>
