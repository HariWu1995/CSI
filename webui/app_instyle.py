...
# load SDXL pipeline
pipe = SDXLControlnetPipeline.from_pretrained(
    base_model_path,
...
def create_image(image_pil,
    ...
    ip_model = IPAdapterXL(pipe, image_encoder_path, ip_adapter_path, device, target_blocks=target_blocks)
    ...
    with gr.Tabs():
        with gr.Row():
            with gr.Column():
                ...
                scale = gr.Slider(minimum=0, maximum=2., step=0.01, value=1.0, label="Scale")
                ...
                with gr.Accordion(open=False, label="Advanced Options"):
                    ...
                    num_steps = gr.Slider(minimum=5, maximum=50.0, step=1.0, value=20, label="num inference steps")
